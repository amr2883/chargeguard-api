...
return array(
    'ChargeGuard_API_Client' => $baseDir . '/includes/class-api-client.php',
    'ChargeGuard_Admin_Settings' => $baseDir . '/includes/class-admin-settings.php',
    'ChargeGuard_Auto_Block_Trait' => $baseDir . '/includes/trait-chargeguard-auto-block.php',
    'ChargeGuard_Blocked_Exception' => $baseDir . '/includes/class-dynamic-firewall.php',
    'ChargeGuard_Dynamic_Firewall' => $baseDir . '/includes/class-dynamic-firewall.php',
    'ChargeGuard_PayPal_Webhook' => $baseDir . '/includes/class-paypal-webhook.php',
    'ChargeGuard_Plugin_Updater' => $baseDir . '/includes/class-plugin-updater.php',
    'ChargeGuard_Privacy' => $baseDir . '/includes/class-privacy.php',
    'ChargeGuard_Secret_Crypto' => $baseDir . '/includes/class-admin-settings.php',
    'ChargeGuard_Stripe_Webhook' => $baseDir . '/includes/class-stripe-webhook.php',
