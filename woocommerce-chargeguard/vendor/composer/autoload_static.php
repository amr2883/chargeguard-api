...
class ComposerStaticInit0b71d1176c1725e04ab44403e556bdb9
{
    ...
    public static $classMap = array (
        'ChargeGuard_API_Client' => __DIR__ . '/../..' . '/includes/class-api-client.php',
        'ChargeGuard_Admin_Settings' => __DIR__ . '/../..' . '/includes/class-admin-settings.php',
        'ChargeGuard_Auto_Block_Trait' => __DIR__ . '/../..' . '/includes/trait-chargeguard-auto-block.php',
        'ChargeGuard_Blocked_Exception' => __DIR__ . '/../..' . '/includes/class-dynamic-firewall.php',
        'ChargeGuard_Dynamic_Firewall' => __DIR__ . '/../..' . '/includes/class-dynamic-firewall.php',
        'ChargeGuard_PayPal_Webhook' => __DIR__ . '/../..' . '/includes/class-paypal-webhook.php',
        'ChargeGuard_Plugin_Updater' => __DIR__ . '/../..' . '/includes/class-plugin-updater.php',
        'ChargeGuard_Privacy' => __DIR__ . '/../..' . '/includes/class-privacy.php',
        'ChargeGuard_Secret_Crypto' => __DIR__ . '/../..' . '/includes/class-admin-settings.php',
        'ChargeGuard_Stripe_Webhook' => __DIR__ . '/../..' . '/includes/class-stripe-webhook.php',
    ...
    public static function getInitializer(ClassLoader $loader)
    {
        return \Closure::bind(function () use ($loader) {
            $loader->prefixLengthsPsr4 = ComposerStaticInit0b71d1176c1725e04ab44403e556bdb9::$prefixLengthsPsr4;
            $loader->prefixDirsPsr4 = ComposerStaticInit0b71d1176c1725e04ab44403e556bdb9::$prefixDirsPsr4;
            $loader->classMap = ComposerStaticInit0b71d1176c1725e04ab44403e556bdb9::$classMap;
