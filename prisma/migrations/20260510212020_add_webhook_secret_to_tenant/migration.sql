...
CREATE TABLE "MerchantProfile" (
    ...
    "merchantWeightRatio" REAL NOT NULL DEFAULT 0.0,
    "trustScore" REAL NOT NULL DEFAULT 0.3,
    "reportCount" INTEGER NOT NULL DEFAULT 0,
    "tenantId" TEXT,
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" DATETIME NOT NULL,
    CONSTRAINT "MerchantProfile_tenantId_fkey" FOREIGN KEY ("tenantId") REFERENCES "Tenant" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
...
CREATE TABLE "RiskEvaluation" (
    ...
    "decisionBefore" TEXT,
    "decisionAfter" TEXT,
    CONSTRAINT "RiskEvaluation_orderId_fkey" FOREIGN KEY ("orderId") REFERENCES "Order" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "DisputeOutcome" (
    ...
    CONSTRAINT "DisputeOutcome_orderId_fkey" FOREIGN KEY ("orderId") REFERENCES "Order" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
...
CREATE TABLE "FraudPattern" (
    ...
    CONSTRAINT "FraudPattern_clusterId_fkey" FOREIGN KEY ("clusterId") REFERENCES "FraudCluster" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
...
CREATE TABLE "FraudCluster" (
    ...
    "fraudCount" INTEGER NOT NULL DEFAULT 0,
    "merchantsSeen" INTEGER NOT NULL DEFAULT 0,
    "weightedFraudScore" REAL NOT NULL DEFAULT 0,
    "firstSeen" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "lastSeen" DATETIME NOT NULL
);
...
CREATE TABLE "PatternMerchant" (
    ...
    PRIMARY KEY ("patternHash", "merchantId")
);
...
CREATE TABLE "IdentityEdge" (
    ...
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" DATETIME NOT NULL,
    CONSTRAINT "IdentityEdge_fromId_fkey" FOREIGN KEY ("fromId") REFERENCES "IdentityNode" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT "IdentityEdge_toId_fkey" FOREIGN KEY ("toId") REFERENCES "IdentityNode" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "ComputedIdentityRisk" (
    ...
    "alertLevel" TEXT,
    "fraudWeight" REAL NOT NULL,
    "cleanWeight" REAL NOT NULL,
    "eventCount" INTEGER NOT NULL,
    "computedAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,

    PRIMARY KEY ("nodeId", "algorithmVersion")
);

-- CreateTable
CREATE TABLE "BinRecord" (
    "bin" TEXT NOT NULL PRIMARY KEY,
    "brand" TEXT,
    "cardType" TEXT,
    "issuerName" TEXT,
    "issuerCountry" TEXT,
